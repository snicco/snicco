...
interface Event
{
     ...
     * You can use the trait "ClassAsName" to automatically achieve this behaviour and reduce
     * duplication.
     *
     * @return string
     * @see ClassAsName
     ...
     * The event name is always passed as a last argument listeners don't have to receive nor use
     *     it.
     * @see Listener::call()
     * @see ClassAsPayload
     * You can also use a custom payload.
     * Assuming your payload is [$user_name,$user_id] a listener would receive:
     * $user_name, $user_id, $event_name
     */
