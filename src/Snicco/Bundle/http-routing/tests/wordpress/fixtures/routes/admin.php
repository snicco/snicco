...
return function (AdminRoutingConfigurator $router) {
    ...
    $router->page('server_error', 'admin.php/server_error', [HttpRunnerTestController::class, 'serverError']);
    $router->page('do_nothing', 'admin.php/do_nothing', [HttpRunnerTestController::class, 'noResponse']);
};