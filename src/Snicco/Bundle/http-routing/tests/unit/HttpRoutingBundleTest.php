...
final class HttpRoutingBundleTest extends TestCase
{
    ...
    public function test_routing_dirs_default_to_empty_array(): void
    {
        ...
        $this->assertSame(
            ...
            $kernel->config()
                ->get('routing.api_route_directories')
        );
    }
    ...
    public function test_middleware_options_have_defaults(): void
    {
        ...
        $this->assertSame([
            ...
            'admin' => [],
            'api' => [],
            'global' => [SetUserId::class],
        ], $kernel->config()
            ->getArray('middleware.middleware_groups'));
    ...
    public function test_kernel_middleware_defaults_to_the_correct_routing_setup(): void
    {
        ...
        $this->assertSame(
            ...
            $kernel->config()
                ->getArray('middleware.kernel_middleware')
        );
    }
    ...
    public function test_url_matcher_can_be_resolved(): void
    {
        ...
        $matcher = $kernel->container()
            ->make(UrlMatcher::class);
