<?php
    ...
    use WPMvc\Auth\Confirmation\EmailAuthConfirmation;
    use WPMvc\Auth\Confirmation\TwoFactorAuthConfirmation;
    ...
    use WPMvc\Auth\Listeners\GenerateNewAuthCookie;
    use WPMvc\Auth\Listeners\RefreshAuthCookies;
    use WPMvc\Auth\Listeners\WpLoginLinkGenerator;
    ...
    use WPMvc\Auth\Responses\EmailRegistrationViewResponse;
    use WPMvc\Auth\Responses\Google2FaChallengeResponse;
    use WPMvc\Auth\Contracts\LoginResponse;
    use WPMvc\Auth\Contracts\LoginViewResponse;
    use WPMvc\Auth\Responses\PasswordLoginView;
    use WPMvc\Auth\Responses\RedirectToDashboardResponse;
