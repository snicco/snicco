...
//         {
//
//             // Normally in production we dont need a try catch block since Wordpress global error handler
...
//         {
//
//             $count = DB::table('football_teams')->where('name', $team_name)
//                                       ->count('*');
//
...
//         }
//
//         private function removeWpBrowserTransaction()
//         {
//
//             global $wpdb;
//             $wpdb->query('COMMIT');
