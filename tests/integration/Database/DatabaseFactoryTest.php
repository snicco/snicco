<?php
    ...
    use Tests\fixtures\database\Factories\CountryFactory;
    use Tests\fixtures\database\Models\Activity;
    use Tests\fixtures\database\Models\City;
    use Tests\fixtures\database\Models\Country;
    use Tests\fixtures\database\Factories\ActivityFactory;

    class DatabaseFactoryTest extends DatabaseTestCase
    {
